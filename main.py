...
#make_group_xlsx_from_raw_data(filename, compositionbound, distancebound, timescope)
...
cluster_result, centers = dtwKMeans(MTS_dataset_preprocessed, 5, compositionbound)
